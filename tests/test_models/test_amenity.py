...
"""
This module contains unittest for Amenity class
"""
...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Amenity] (12345)", amenity_str)
        self.assertIn("'id': '12345'", amenity_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        a1 = Amenity(id="123", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(a1.id, "123")
        self.assertEqual(a1.created_at, my_date)
        self.assertEqual(a1.updated_at, my_date)
...
class TestAmenity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        amenity1 = Amenity()
        amenity1.middle_name = "Razig"
        amenity1.my_number = 123
        self.assertEqual("Razig", amenity1.middle_name)
