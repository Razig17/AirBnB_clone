...
"""
This module contains unittest for City class
"""
...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[City] (1234)", my_city_str)
        self.assertIn("'id': '1234'", my_city_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        m_city = City(id="123", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(m_city.id, "123")
        self.assertEqual(m_city.created_at, my_date)
        self.assertEqual(m_city.updated_at, my_date)
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        my_city = City()
        my_city.middle_name = "Razig"
        my_city.my_number = 123
        self.assertEqual("Razig", my_city.middle_name)
