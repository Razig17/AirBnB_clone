...
"""
This module contains unittest for Place class
"""
import os
import models
import unittest
...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Place] (12345)", my_place_str)
        self.assertIn("'id': '12345'", my_place_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        my_p = Place(id="123", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(my_p.id, "123")
        self.assertEqual(my_p.created_at, my_date)
        self.assertEqual(my_p.updated_at, my_date)
