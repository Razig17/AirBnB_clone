#!/usr/bin/python3
"""
This module contains unittest for Review class
"""
import os
import models
import unittest
...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Review] (12345)", review_str)
        self.assertIn("'id': '12345'", review_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        review = Review(id="1", created_at=my_date_iso, updated_at=my_date_iso)
...
class TestReview_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        review = Review()
        review.middle_name = "Razig"
        review.my_number = 123
        self.assertEqual("Razig", review.middle_name)
