...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[State] (12123)", state_str)
        self.assertIn("'id': '12123'", state_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        state = State(id="123", created_at=my_date_iso, updated_at=my_date_iso)
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        state = State()
        state.middle_name = "Razig"
        state.my_number = 123
        self.assertEqual("Razig", state.middle_name)
